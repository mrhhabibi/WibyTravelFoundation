...
public class FakeJadwalRepository implements JadwalRepository {
	...
	public FakeJadwalRepository() {
		this.jadwals.add(new Jadwal(1, "Gresik", "Bali", "12/3/2013","12.00", 30));
		this.jadwals.add(new Jadwal(2, "Surabaya", "Bandung", "2/5/2013","03.00", 90));
		this.jadwals.add(new Jadwal(3, "Kediri", "Bengkulu", "11/4/2014","11.30", 20));
		this.jadwals.add(new Jadwal(4, "Jakarta", "Banyuwangi", "13/3/2014","00.30", 10));
	}
	...
	public List<Jadwal> getData(String asal, String tujuan, String tanggal,
		...
		jadwalFilter.add(new Jadwal(1, "Gresik", "Bali", "12/3/2013","12.00", 30));
		jadwalFilter.add(new Jadwal(2, "Surabaya", "Bandung", "2/5/2013","03.00", 90));
		return jadwalFilter;
	}
