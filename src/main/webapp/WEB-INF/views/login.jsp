...
<script type="text/javascript">
	function cek() {
		if (document.getElementById("namaText").Value == "") {
			windows.alert("Nama Kosong");
			return false;
		}
		else
			return true;
	...
	<div class="container">
		...
		<div class="codrops-top">
			<a href=""> <strong>Wiby Corporation: </strong>Wiby Travel
				Foundation
			</a> <span class="right"> <a href="/fp"> <strong>Halaman
						Utama</strong>
			</a>
			</span>
			<div class="clr"></div>
					...
					<div id="login" class="animate form">
						<form:form method="post" action="loginProcess"
							...
							<p>
								...
								<form:input id="namaText" path="email"
									placeholder="rizkyhabibi09@gmail.com" />
							</p>
							<p>
							...
							<p class="change_link">
								Belum menjadi anggota? <a href="/fp/register"
									class="to_register">Daftar Sekarang!</a>
							</p>
						</form:form>
					</div>
				</div>
